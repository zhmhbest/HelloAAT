...
**解题思路**：`工作量 × (1 - 1/(1 + 提升率)) = 原工作效率 × 提前时间`、（<span class='hint'>工作量/原工作效率 - 工作量/新工作效率 = 提前时间</span>）

**例1**：计划植树300棵，实际效率为原效率1.2倍，结果提前20分钟完成，求原效率（棵/小时）？

$e = \dfrac{300 × (1 - \frac{1}{1.2})}{\frac{1}{3}} = 150$
...
$
    \begin{cases}
        q(1 - \frac{4}{5}) = 9e
    \\  (q-4000)(1 - \frac{3}{4}) = 5e
    \end{cases} ~⇒~ e=160, q=7200
$

#### 合作工程

**解题思路**：`总工作量 = 所有人工作效率和 × 总工作时间`
...
**例2**：四人合作效率比为$3:5:4:6$，前2个合作比后2个合作多9天，问4人合作共需要多少天？

$\dfrac{q}{8e} - \dfrac{q}{10e} = 9 ~⇒~ \dfrac{q}{18e} = 20$

**例3**：3名绣工8天可完成，完成50%时一人离开，完成75%时又一人离开，最后实际用了几天。

$
    \begin{cases}
        q = 3e × 8 = 24e ~⇒~ \frac{q}{e}=24
    \\  \frac{1}{2}q = 3e × t_1 ~⇒~ t_1 = 4
    \\  \frac{3}{4}q - \frac{1}{2}q = 2e × t_2 ~⇒~ t_2 = 3
    \\  \frac{1}{4}q = e × t_3 ~⇒~ t_3 = 6
    \end{cases} ~⇒~ t_1 + t_2 + t_3 = 13
$
